...
for g in check_lex_escapes check_mixed_width_binops check_type_agreement check_differential_positions check_copy_judgment check_ownership_judgment check_corecheck_boundary check_capability_judgment check_trailing_value_blocks; do
