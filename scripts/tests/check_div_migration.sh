...
ck "hmac_sha256: 9 div VCs, 8 proved / 1 unproven" "examples/hmac_sha256/src/main.con" \
  "len(DZ)==9 and dist().get('proved_by_kernel_decision')==8 and dist().get('unproven')==1"
