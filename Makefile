...
test-float-cast-hole: build ## Known-hole gate: float->int cast overflow unchecked (docs/KNOWN_HOLES.md H2)
	$(NIX_DEVELOP) bash ./scripts/tests/check_float_cast_hole.sh
