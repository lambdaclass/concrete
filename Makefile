.PHONY: build test test-full test-trust-gate test-proof-gate test-ssa test-fuzz test-oracle test-wrong-code test-reducer-smoke test-bundle-smoke test-verify-gates test-assumptions test-policy test-catches test-snapshots test-pv-oracle test-cv-oracle test-fc-oracle test-ct-oracle test-release-bundle test-showcase clean check-grammar paper paper-ec papers docs-site docs-serve
