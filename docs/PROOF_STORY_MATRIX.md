...
| Width-tagged mod / bitxor / bitor / bitand / shr / shl | proved at extraction shape; trusted for backend equivalence | R-16/R-17/R-21/R-22/R-23/R-24/R-25 register entries; BitVec eval rules | BitVec-vs-LLVM semantic agreement; more widths/ops by forcing example |
